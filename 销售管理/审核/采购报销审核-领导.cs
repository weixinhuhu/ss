...
namespace 销售管理.审核
{
    public partial class 采购报销审核_领导 : 销售管理.Main.报销审核Base
    {
        public 采购报销审核_领导()
        {
            InitializeComponent();
        ...
        private void InitCmb()
        {
            ...
            cmbHasAudit.DataSource = new[] { new { IntID = 5, VcDesc = "未审核" }, new { IntID = 6, VcDesc = "审核未通过" }, new { IntID = 7, VcDesc = "审核已通过" } };
        ...
        {
            if ((int)cmbHasAudit.SelectedValue == 5)
            {
        ...
        private void 采购报销审核_领导_Load(object sender, EventArgs e)
        {
